...
utr5_seqs <- readDNAStringSet(filepath = "20251015_MANE_5utr.fasta")	# 20251015_NAT1motif_1.txt
...
setwd(HOMEDIR)
setwd("20251015_MANE_5utr")
NAT1motifDF <- read.xlsx(xlsxFile = "20251015_MANE_5utr_NAT1motif.xlsx")	# 20251015_NAT1motif_1.txt
...
setwd(HOMEDIR)
setwd("20251015_MANE_5utr")
NAT1motifDF_Rv <- read.xlsx(xlsxFile = "20251015_MANE_5utr_NAT1motif_Rv.xlsx")	# 20251015_NAT1motif_2.txt
...
setwd(HOMEDIR)
setwd("20251015_MANE_5utr")
write.xlsx(outDF, file = "20251017_NAT1motif_64codons.xlsx")
