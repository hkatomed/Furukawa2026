## original file: 20251205_NAT1motif_fly_1_addG.txt

HOMEDIR <- getwd()
setwd(HOMEDIR)
setwd("20251018_FB2025_03")
library(Biostrings)
utr5_seqs <- readDNAStringSet(filepath = "dmel-all-five_prime_UTR-r6.64.fasta.gz")
geneNames <- names(utr5_seqs)
for(i in 1:length(geneNames)){
	geneName <- geneNames[i]
	geneNames[i] <- strsplit(geneName, split = " ")[[1]][1]
}
names(utr5_seqs) <- geneNames
...
library(openxlsx)
setwd(HOMEDIR)
dir.create("20251018_fly_5utr")
setwd("20251018_fly_5utr")
write.xlsx(NAT1motifDF, file = "20251205_fly_5utr_NAT1motif_addG.xlsx")
...
setwd(HOMEDIR)
setwd("20251018_fly_5utr")
write.xlsx(NAT1motifDF_Rv, file = "20251205_fly_5utr_NAT1motif_addG_Rv.xlsx")
...
setwd(HOMEDIR)
setwd("20251018_fly_5utr")
write.xlsx(outDF, file = "20251205_fly_5utr_NAT1motif_64codons_addG.xlsx")
