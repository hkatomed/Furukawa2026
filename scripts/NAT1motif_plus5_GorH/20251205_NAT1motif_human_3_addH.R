## original file: 20251205_NAT1motif_human_3_addH.txt
...
setwd(HOMEDIR)
setwd("20251015_MANE_5utr")
NAT1motifDF <- read.xlsx(xlsxFile = "20251205_MANE_5utr_NAT1motif_addH.xlsx")
...
setwd(HOMEDIR)
setwd("20251015_MANE_5utr")
NAT1motifDF_Rv <- read.xlsx(xlsxFile = "20251205_MANE_5utr_NAT1motif_addH_Rv.xlsx")
...
setwd(HOMEDIR)
setwd("20251015_MANE_5utr")
write.xlsx(outDF, file = "20251205_NAT1motif_64codons_addH.xlsx")