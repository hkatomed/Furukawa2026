## original file: 20251205_NAT1motif_fly_1_addH.txt
...
write.xlsx(NAT1motifDF, file = "20251205_fly_5utr_NAT1motif_addH.xlsx")
...
setwd(HOMEDIR)
setwd("20251018_fly_5utr")
write.xlsx(NAT1motifDF_Rv, file = "20251205_fly_5utr_NAT1motif_addH_Rv.xlsx")
...
setwd(HOMEDIR)
setwd("20251018_fly_5utr")
write.xlsx(outDF, file = "20251205_fly_5utr_NAT1motif_64codons_addH.xlsx")
