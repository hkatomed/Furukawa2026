## original file: 20251205_NAT1motif1_wheat_1_addH.txt
...
setwd(HOMEDIR)
setwd("20251017_IWGSC_5utr")
write.xlsx(NAT1motifDF, file = "20251205_IWGSC_5utr_NAT1motif_addH.xlsx")
...
setwd(HOMEDIR)
setwd("20251017_IWGSC_5utr")
write.xlsx(NAT1motifDF_Rv, file = "20251205_IWGSC_5utr_NAT1motif_addH_Rv.xlsx")
...
setwd(HOMEDIR)
setwd("20251017_IWGSC_5utr")
write.xlsx(outDF, file = "20251205_IWGSC_5utr_NAT1motif_64codons_addH.xlsx")