## original file: 20251205_NAT1motif_4_addH_3species.txt

library(openxlsx)
HOMEDIR <- getwd()
INDIR1 <- "20251015_MANE_5utr"
INXLSX1 <- "20251205_NAT1motif_64codons_addH.xlsx"
SHEET1 <- "human"
INDIR2 <- "20251018_fly_5utr"
INXLSX2 <- "20251205_fly_5utr_NAT1motif_64codons_addH.xlsx"
SHEET2 <- "fly"
INDIR3 <- "20251017_IWGSC_5utr"
INXLSX3 <- "20251205_IWGSC_5utr_NAT1motif_64codons_addH.xlsx"
SHEET3 <- "wheat"
OUTXLSX <- "20251205_NAT1motif_3species_addH.xlsx"
outList <- list()
setwd(HOMEDIR)
setwd(INDIR1)
