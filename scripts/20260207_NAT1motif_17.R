HOMEDIR <- getwd()
INDIR <- "20251016_MANE_cds"
INXLSX <- "20251021_NAT1motif_64codons_cds.xlsx"
OUTDIR <- "20251021_MANE_cds_withATC"
OUTXLSX <- "20251021_NAT1motif_64codons_cds_withATC.xlsx"
library(Biostrings)
library(openxlsx)
setwd(HOMEDIR)
setwd(INDIR)
