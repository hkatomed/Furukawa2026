...
setwd(HOMEDIR)
setwd("20251017_URGI")
command1 <- "unzip iwgsc_refseqv2.1_assembly.fa.zip"
command2 <- "gzip iwgsc_refseqv2.1_assembly.fa"
system(command1)
system(command2)
...
writeXStringSet(utr5_seqs, filepath = "20251017_IWGSC_5utr.fasta")
write.table(utr5_df, file = "20251017_IWGSC_5utr.txt", quote = FALSE, col.names = TRUE, row.names = FALSE, sep = "\t")
write.xlsx(utr5_df, file = "20251017_IWGSC_5utr.xlsx")
...
setwd(HOMEDIR)
setwd("20251017_IWGSC_5utr")
write.xlsx(NAT1motifDF, file = "20251017_IWGSC_5utr_NAT1motif.xlsx")
...
setwd(HOMEDIR)
setwd("20251017_IWGSC_5utr")
write.xlsx(NAT1motifDF_Rv, file = "20251017_IWGSC_5utr_NAT1motif_Rv.xlsx")
...
setwd(HOMEDIR)
setwd("20251017_IWGSC_5utr")
write.xlsx(outDF, file = "20251017_IWGSC_5utr_NAT1motif_64codons.xlsx")
