HOMEDIR <- getwd()
INDIR <- "20251018_fly_5utr"
INXLSX <- "20251018_fly_5utr_NAT1motif_64codons.xlsx"
OUTDIR <- "20251019_fly_5utr_withATC"
OUTXLSX <- "20251019_fly_5utr_NAT1motif_64codons_withATC.xlsx"
library(Biostrings)
library(openxlsx)
setwd(HOMEDIR)
setwd(INDIR)
