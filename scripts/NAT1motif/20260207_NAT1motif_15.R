...
SHEET1 <- "human"
INDIR2 <- "20251019_fly_5utr_withATC"
INXLSX2 <- "20251019_fly_5utr_NAT1motif_64codons_withATC.xlsx"
SHEET2 <- "fly"
INDIR3 <- "20251019_IWGSC_5utr_withATC"
INXLSX3 <- "20251019_IWGSC_5utr_NAT1motif_64codons_withATC.xlsx"
SHEET3 <- "wheat"
OUTXLSX <- "20251019_NAT1motif_3species_withATC.xlsx"
outList <- list()
setwd(HOMEDIR)
setwd(INDIR1)
