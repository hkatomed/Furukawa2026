...
write.xlsx(NAT1motifDF, file = "20251018_fly_5utr_NAT1motif.xlsx")
...
setwd(HOMEDIR)
setwd("20251018_fly_5utr")
write.xlsx(NAT1motifDF_Rv, file = "20251018_fly_5utr_NAT1motif_Rv.xlsx")
...
setwd(HOMEDIR)
setwd("20251018_fly_5utr")
write.xlsx(outDF, file = "20251018_fly_5utr_NAT1motif_64codons.xlsx")
