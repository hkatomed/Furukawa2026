HOMEDIR <- getwd()
INDIR <- "20251016_MANE_3utr"
INXLSX <- "20251021_NAT1motif_64codons_utr3.xlsx"
OUTDIR <- "20251021_MANE_3utr_withATC"
OUTXLSX <- "20251021_NAT1motif_64codons_utr3_withATC.xlsx"
library(Biostrings)
library(openxlsx)
setwd(HOMEDIR)
setwd(INDIR)
