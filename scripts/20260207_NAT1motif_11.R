...
cds_seqs <- readDNAStringSet(filepath = "20251016_MANE_cds.fasta")	# 20251016_NAT1motif_1.txt
oneBaseFreq <- oligonucleotideFrequency(cds_seqs, width = 1, simplify.as = "collapsed", as.prob = FALSE)
twoBaseFreq <- oligonucleotideFrequency(cds_seqs, width = 2, simplify.as = "collapsed", as.prob = FALSE)
threeBaseFreq <- oligonucleotideFrequency(cds_seqs, width = 3, simplify.as = "collapsed", as.prob = FALSE)
...
oneBaseFreqProb <- oligonucleotideFrequency(cds_seqs, width = 1, simplify.as = "collapsed", as.prob = TRUE)
twoBaseFreqProb <- oligonucleotideFrequency(cds_seqs, width = 2, simplify.as = "collapsed", as.prob = TRUE)
threeBaseFreqProb <- oligonucleotideFrequency(cds_seqs, width = 3, simplify.as = "collapsed", as.prob = TRUE)
...
setwd(HOMEDIR)
setwd("20251016_MANE_cds")
NAT1motifDF <- read.xlsx(xlsxFile = "20251016_MANE_cds_NAT1motif.xlsx")	# 20251016_NAT1motif_3.txt
...
cds_seqs_Rv <- reverseComplement(cds_seqs)
oneBaseFreq_Rv <- oligonucleotideFrequency(cds_seqs_Rv, width = 1, simplify.as = "collapsed", as.prob = FALSE)
twoBaseFreq_Rv <- oligonucleotideFrequency(cds_seqs_Rv, width = 2, simplify.as = "collapsed", as.prob = FALSE)
threeBaseFreq_Rv <- oligonucleotideFrequency(cds_seqs_Rv, width = 3, simplify.as = "collapsed", as.prob = FALSE)
...
oneBaseFreqProb_Rv <- oligonucleotideFrequency(cds_seqs_Rv, width = 1, simplify.as = "collapsed", as.prob = TRUE)
twoBaseFreqProb_Rv <- oligonucleotideFrequency(cds_seqs_Rv, width = 2, simplify.as = "collapsed", as.prob = TRUE)
threeBaseFreqProb_Rv <- oligonucleotideFrequency(cds_seqs_Rv, width = 3, simplify.as = "collapsed", as.prob = TRUE)
...
setwd(HOMEDIR)
setwd("20251016_MANE_cds")
NAT1motifDF_Rv <- read.xlsx(xlsxFile = "20251016_MANE_cds_NAT1motif_Rv.xlsx")	# 20251016_NAT1motif_1.txt
...
setwd(HOMEDIR)
setwd("20251016_MANE_cds")
write.xlsx(outDF, file = "20251021_NAT1motif_64codons_cds.xlsx")
